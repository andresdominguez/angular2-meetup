...
declare module "angular2/http" {
  class Http {
    ...
    request(url: string | any, options?: any): Rx.Observable<any>;
    get(url: string, options?: any): Rx.Observable<any>;
    post(url: string, body: any | FormData | Blob | string, options?: any): Rx.Observable<any>;
    put(url: string, body: any | FormData | Blob | string, options?: any): Rx.Observable<any>;
    delete(url: string, options?: any): Rx.Observable<any>;
    patch(url: string, body: any | FormData | Blob | string, options?: any): Rx.Observable<any>;
    head(url: string, options?: any): Rx.Observable<any>;
  }
